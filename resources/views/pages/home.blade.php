...
<main id="main">
      ...
      <section class="section faq-section" id="faq">
        <div class="container">
          ...
          <div class="faq-list">
        <article class="faq-item"><button class="faq-question" type="button" aria-expanded="false"><span>What is FitFreak Pro?</span><span aria-hidden="true">+</span></button><div class="faq-answer">FitFreak Pro is personal trainer software for building an exercise library, using your own videos, assigning workouts, setting nutrition targets, and reviewing client progress.</div></article>
            <article class="faq-item"><button class="faq-question" type="button" aria-expanded="false"><span>Who is FitFreak Pro for?</span><span aria-hidden="true">+</span></button><div class="faq-answer">It is built for independent personal trainers, online coaches, hybrid trainers, and small personalized coaching businesses.</div></article>
            <article class="faq-item"><button class="faq-question" type="button" aria-expanded="false"><span>Is FitFreak Pro free for trainers?</span><span aria-hidden="true">+</span></button><div class="faq-answer">Yes. Trainers can register for free, build their exercise library, invite clients, and manage active subscribed clients without a monthly coach platform fee.</div></article>
            <article class="faq-item"><button class="faq-question" type="button" aria-expanded="false"><span>Why does the client pay a monthly subscription?</span><span aria-hidden="true">+</span></button><div class="faq-answer">The subscription gives the client access to workouts, exercise videos, nutrition targets, and progress tools provided by their trainer through FitFreak Pro.</div></article>
            <article class="faq-item"><button class="faq-question" type="button" aria-expanded="false"><span>Can trainers use their own exercise videos?</span><span aria-hidden="true">+</span></button><div class="faq-answer">Yes. Trainers can build their own exercise library and use their own videos, demonstrations, instructions, and coaching notes.</div></article>
            <article class="faq-item"><button class="faq-question" type="button" aria-expanded="false"><span>Can FitFreak Pro support online and in-person clients?</span><span aria-hidden="true">+</span></button><div class="faq-answer">Yes. FitFreak Pro supports trainers who work online, in person, or through a hybrid coaching model.</div></article>
            <article class="faq-item"><button class="faq-question" type="button" aria-expanded="false"><span>How does a client join?</span><span aria-hidden="true">+</span></button><div class="faq-answer">A client joins after receiving an invitation from their trainer. After subscription access is active, the trainer can manage that client from the dashboard.</div></article>
            <article class="faq-item"><button class="faq-question" type="button" aria-expanded="false"><span>Where can the application be downloaded?</span><span aria-hidden="true">+</span></button><div class="faq-answer">FitFreak Pro is available on the Apple App Store and Google Play.</div></article>
            <article class="faq-item"><button class="faq-question" type="button" aria-expanded="false"><span>How can a trainer request a walkthrough?</span><span aria-hidden="true">+</span></button><div class="faq-answer">Email <a class="email-link" href="mailto:support@fitfreakpro.com?subject=FitFreak%20Pro%20walkthrough" data-track="founder_walkthrough_click">support@fitfreakpro.com</a> with the subject FitFreak Pro walkthrough.</div></article>
            <article class="faq-item"><button class="faq-question" type="button" aria-expanded="false"><span>Is FitFreak Pro a healthcare or medical service?</span><span aria-hidden="true">+</span></button><div class="faq-answer">No. FitFreak Pro is not a healthcare provider, medical service, emergency service, or substitute for professional medical advice.</div></article>
          </div>
        </div>
      </section>
