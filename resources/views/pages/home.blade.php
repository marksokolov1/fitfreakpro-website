...
<main id="main" class="home-page">
        ...
        <div class="container hero-grid">
          ...
          <div class="product-shot-grid" aria-label="FitFreak Pro product screenshots">
            ...
            <figure class="phone-shot phone-shot-secondary">
              <img src="{{ asset('images/tutorial/coach/02-exercise-library.png') }}" width="922" height="2000" alt="FitFreak Pro coach exercise library screen" loading="eager" />
            </figure>
          </div>
        </div>
      </section>
      ...
      <section class="section home-band home-band-primary" id="workflow">
        ...
        <div class="container workflow-showcase">
          <figure class="workflow-product-shot">
            <img src="{{ asset('images/tutorial/coach/04-create-program.png') }}" width="922" height="2000" alt="FitFreak Pro coach screen for creating and assigning a workout program" loading="lazy" />
          </figure>
          <div class="workflow-flow" aria-label="Coach workflow steps">
      ...
      <section class="section feature-split home-feature home-feature-primary" id="features">
        ...
        <div class="container split-panel">
          ...
          <figure class="app-ui-frame">
            <img src="{{ asset('images/tutorial/coach/02-exercise-library.png') }}" width="922" height="2000" alt="FitFreak Pro exercise library screen" loading="lazy" />
          </figure>
        </div>
      </section>
      ...
      <section class="section feature-split home-feature home-feature-client" id="client-experience">
        <div class="container split-panel reverse">
          <figure class="app-ui-frame">
            <img src="{{ asset('images/tutorial/client/04-client-dashboard.png') }}" width="922" height="2000" alt="Client dashboard showing nutrition values and current workout" loading="lazy" />
          </figure>
          <div>
      ...
      <section class="section feature-split home-feature home-secondary-feature" id="coach-calendar">
        <div class="container split-panel reverse">
          <figure class="app-ui-frame app-ui-frame-compact"><img src="{{ asset('images/tutorial/coach/06-coach-calendar.png') }}" width="922" height="2000" alt="Coach calendar screen with schedule blocks in FitFreak Pro" loading="lazy" /></figure>
          <div>
