      ...
      <section class="section pricing-model-section">
        <div class="container">
          ...
          <div class="pricing-grid">
            <article class="pricing-card featured"><p class="pricing-label">Coach account</p><div class="price"><span>$0</span><small>per month</small></div><p>Create your exercise library, invite clients, and manage active subscribed clients without paying a monthly coach platform fee.</p><ul><li>Build your exercise library</li><li>Add your own videos</li><li>Invite clients</li><li>Assign workouts</li><li>Set nutrition targets</li><li>Review client-submitted progress</li><li>No monthly coach platform fee</li></ul></article>
            <article class="pricing-card"><p class="pricing-label">Invited client access</p><div class="price"><span>$12.99</span><small>per month</small></div><p>Clients subscribe after receiving an invitation from their coach.</p><ul><li>Access coach-assigned workouts</li><li>View exercise instructions and videos</li><li>Follow assigned nutrition targets</li><li>Submit progress information</li><li>Stay connected to the coaching plan</li></ul></article>
          </div>
          ...
          <div class="cta-panel pricing-cta-panel">
            <div><h2>Ready to start as a trainer?</h2><p>Download FitFreak Pro to create your free coach account in the app.</p><div class="cta-actions"><a class="btn btn-primary" href="{{ route('home') }}#download" data-track="pricing_cta_click">Download the Free Coach App</a><a class="btn btn-secondary" href="mailto:support@fitfreakpro.com?subject=FitFreak%20Pro%20walkthrough" data-track="founder_walkthrough_click">Request a Product Walkthrough</a></div></div>
