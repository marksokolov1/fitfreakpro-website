...
<main id="main" class="how-it-works-page">
      ...
      <section class="section how-it-works-workflow-section"><div class="container"><div class="workflow-timeline">
        <article class="workflow-step"><figure class="workflow-app-shot workflow-app-shot-registration"><img src="{{ asset('images/tutorial/coach/01-create-coach-account.png') }}" width="922" height="2000" alt="Coach account registration screen in FitFreak Pro" loading="lazy" /></figure><div><span>Step 1</span><h2>Create your free coach account</h2><p>Download FitFreak Pro and register as a coach.</p></div></article>
        <article class="workflow-step"><figure class="workflow-app-shot"><img src="{{ asset('images/tutorial/coach/02-exercise-library.png') }}" width="922" height="2000" alt="Exercise library screen in FitFreak Pro" loading="lazy" /></figure><div><span>Step 2</span><h2>Build your exercise library</h2><p>Add your own exercises, videos, instructions, and coaching notes.</p></div></article>
        <article class="workflow-step"><figure class="workflow-app-shot"><img src="{{ asset('images/tutorial/coach/03-invite-client.png') }}" width="922" height="2000" alt="Client invitation screen in FitFreak Pro" loading="lazy" /></figure><div><span>Step 3</span><h2>Invite a client</h2><p>Send an invitation so the client can access the workouts and guidance you assign.</p></div></article>
        <article class="workflow-step"><figure class="workflow-app-shot"><img src="{{ asset('images/tutorial/coach/04-create-program.png') }}" width="922" height="2000" alt="Workout program assignment screen in FitFreak Pro" loading="lazy" /></figure><div><span>Step 4</span><h2>Assign plans and review progress</h2><p>Assign workouts, set nutrition targets, and review the progress information submitted by the client.</p></div></article>
      </div></div></section>
      <section class="section how-it-works-cta-section"><div class="container cta-panel"><h2>See whether FitFreak Pro fits the way you coach.</h2><p>See how FitFreak Pro can organize the work you currently manage through spreadsheets, notes, video links, and messages.</p><div class="cta-actions"><a class="btn btn-primary" href="{{ route('home') }}#download" data-track="hero_app_download_cta">Download the Free Coach App</a><a class="btn btn-secondary" href="mailto:support@fitfreakpro.com?subject=FitFreak%20Pro%20walkthrough" data-track="founder_walkthrough_click">Request a Product Walkthrough</a></div></div></section>
    </main>
</x-layouts.public>
