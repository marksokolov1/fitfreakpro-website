...
<main id="main" class="how-it-works-page">
      ...
      <section class="section how-it-works-workflow-section"><div class="container"><div class="workflow-timeline">
        ...
        <article class="workflow-step"><figure class="workflow-app-shot"><img src="{{ asset('images/tutorial/coach/04-create-program.png') }}" width="922" height="2000" alt="Program builder showing exercises, sets, weight or time, and repetitions" loading="lazy" /></figure><div><span>Step 4</span><h2>Assign their program</h2><p>Choose a saved program or create a new one, then set exercises, repetitions, weight or time, and nutrition targets.</p></div></article>
        <article class="workflow-step"><figure class="workflow-app-shot"><img src="{{ asset('images/tutorial/coach/09-nutrition-review.png') }}" width="798" height="1727" alt="Coach review of client nutrition progress with workout and parameter tabs available" loading="lazy" /></figure><div><span>Step 5</span><h2>Review and adjust</h2><p>Review workouts, nutrition, parameters, and submitted progress, then update the plan over time.</p></div></article>
